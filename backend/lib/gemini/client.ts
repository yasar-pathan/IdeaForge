...
const FLASH_MODEL = process.env.OPENROUTER_FLASH_MODEL?.trim() || 'google/gemini-2.5-flash';
const PRO_MODEL = process.env.OPENROUTER_PRO_MODEL?.trim() || 'google/gemini-2.5-pro';
