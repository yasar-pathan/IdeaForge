...
const FLASH_MODEL = process.env.OPENROUTER_FLASH_MODEL?.trim() || 'google/gemini-1.5-flash';
const PRO_MODEL = process.env.OPENROUTER_PRO_MODEL?.trim() || 'google/gemini-1.5-pro';
