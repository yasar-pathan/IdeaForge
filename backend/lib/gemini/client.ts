...
const FLASH_MODEL = process.env.OPENROUTER_FLASH_MODEL?.trim() || 'google/gemini-flash-1.5';
const PRO_MODEL = process.env.OPENROUTER_PRO_MODEL?.trim() || 'google/gemini-pro-1.5';
